# redoc-try OpenAPI Specification
[![Build Status](https://travis-ci.org/thrcorrea/redoc-try.svg?branch=master)](https://travis-ci.org/thrcorrea/redoc-try)
...
6. If you did everything correct, https://thrcorrea.github.io/redoc-try/ will lead to your new docs
...
- Documentation(ReDoc): https://thrcorrea.github.io/redoc-try/
- SwaggerUI: https://thrcorrea.github.io/redoc-try/swagger-ui/
- Look full spec:
    + JSON https://thrcorrea.github.io/redoc-try/swagger.json
    + YAML https://thrcorrea.github.io/redoc-try/swagger.yaml
- Preview spec version for branch `[branch]`: https://thrcorrea.github.io/redoc-try/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://thrcorrea.github.io/redoc-try/ with url from the message: `Server started <url>`
